...
SRC_URI = "git://git.codelinaro.org/clo/le/go-simplejson;protocol=https;nobranch=1;rev=39a59b1b2866b3d321f1d6ca8ad9d1748cc6d8ea;destsuffix=${DEST_DIR}/src/${GO_IMPORT}"
LICENSE = "BSD"

...
SRC_URI = "git://git.codelinaro.org/clo/le/gorilla/websocket;protocol=https;nobranch=1;rev=b378caee5b2a673abe3897c40fde529bff7b986e;destsuffix=${DEST_DIR}/src/${GO_IMPORT}"
LICENSE = "BSD"

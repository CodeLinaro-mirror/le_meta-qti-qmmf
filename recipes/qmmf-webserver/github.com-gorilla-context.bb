...
SRC_URI = "git://source.codeaurora.org/quic/le/gorilla/context;protocol=git;nobranch=1;rev=08b5f424b9271eedf6f9f0ce86cb9396ed337a42;destsuffix=${DEST_DIR}/src/${GO_IMPORT}"
LICENSE = "BSD"

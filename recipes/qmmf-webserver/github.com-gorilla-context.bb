...
SRC_URI = "git://git.codelinaro.org/clo/le/gorilla/context;protocol=https;nobranch=1;rev=08b5f424b9271eedf6f9f0ce86cb9396ed337a42;destsuffix=${DEST_DIR}/src/${GO_IMPORT}"
LICENSE = "BSD"
